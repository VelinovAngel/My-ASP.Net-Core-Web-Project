        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    StatisticsBooked = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ClientsOffers", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ClientsOffers_Clients_ClientId",
                        column: x => x.ClientId,
                        principalTable: "Clients",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ClientsOffers_Offers_OfferId",
                        column: x => x.OfferId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TypeMotor = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Motorcycles_Dealers_DealerId",
                        column: x => x.DealerId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ClientsOffers_ClientId",
                table: "ClientsOffers",
                column: "ClientId");

            migrationBuilder.CreateIndex(
                name: "IX_ClientsOffers_OfferId",
                table: "ClientsOffers",
                column: "OfferId");
